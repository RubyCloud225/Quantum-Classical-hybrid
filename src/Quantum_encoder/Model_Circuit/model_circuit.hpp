...
#include "../../Quantum_encoder/Hamiltonian/training.hpp"
#include <complex>
#include <iostream>
#include <cmath>
...
class ModelCircuit {
    ...
    std::vector<Complex> apply_hybrid_encoding(const std::vector<HybridGate>& hybridGates, const Time::Mat* hamiltonian = nullptr);
