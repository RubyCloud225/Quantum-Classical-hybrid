...
set_target_properties(test_embed_lib PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/libtest_embed_lib.a"
  )

list(APPEND _cmake_import_check_targets test_embed_lib )
list(APPEND _cmake_import_check_files_for_test_embed_lib "${_IMPORT_PREFIX}/bin/libtest_embed_lib.a" )
